...
async def calculate_total_revenue(property_id: str, tenant_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Per-tenant mock data for testing when DB is unavailable.
        # Keyed by (tenant_id, property_id) so prop-001 (which exists for both
        # tenants) doesn't leak tenant-a's numbers to tenant-b.
        mock_data = {
